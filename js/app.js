  ...
  if (node && !isTextbox && !isEditable) {
    ...
    if (node.nodeType === 3) {
      ...
      var replacedText = text
        ...
        .replace(/\breal\b/gi, "papelzinho colorido")
        .replace(/\breais\b/gi, "papeizinhos coloridos")
        ...
        .replace(/\bSTF\b/gi, getRandomWord(["Suprema Tribunal Parasitário", "Supremo Trypanosoma Federal"]))
